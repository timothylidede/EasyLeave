...
public class EmployeeStatusAccepted implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        String verify;
        verify = "SELECT * FROM `tbl_leavedetails` WHERE leave_staff= '" + EmployeeLogin.loggedUser_id + "' AND leave_status = 'Accepted' ";
        try{
...
//            leave_table.setVisible(false);
    ...
    void pending(MouseEvent event) throws IOException {
        ...
        FXMLLoader root = new FXMLLoader(Launch.class.getResource("/savala/easyleave/employee/employee_status_pending.fxml"));
        Scene scene = new Scene(root.load());
        scene.setFill(Color.TRANSPARENT);
        stage.setScene(scene);
        stage.initStyle(StageStyle.TRANSPARENT);
