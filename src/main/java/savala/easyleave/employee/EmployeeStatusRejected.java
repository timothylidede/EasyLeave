...
public class EmployeeStatusRejected implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        String verify;
        verify = "SELECT * FROM `tbl_leavedetails` WHERE leave_staff= '" + EmployeeLogin.loggedUser_id + "' AND leave_status = 'Rejected' ";
        try{
